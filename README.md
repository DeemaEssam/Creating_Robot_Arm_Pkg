 ...
 Navigate to the `src` directory of the workspace using:
   ```sh
   cd ~/catkin_ws/src
   ```

### Step 1: Create the Robot Arm Package
1. Create a new package for the robot arm:
   ```sh
...
### Step 2: Define the Robot Description
1. Create a URDF file for the robot arm in the `urdf` directory:
   ```sh
   mkdir urdf
   cd urdf
...
2. Open the `my_robot_arm.urdf` file and define the URDF for the robot arm.

<img width="947" alt="2" src="https://github.com/user-attachments/assets/7835911d-bfb2-493b-95ff-bc41bf024bf3">

### Step 3: Add Dependencies
1. Open the `package.xml` file and add necessary dependencies for the robot arm package, such as `roscpp`, `std_msgs`, `sensor_msgs`, and any other relevant packages.
...
2. Open `display.launch` and add the launch file code to launch the robot arm in RViz.

<img width="949" alt="5" src="https://github.com/user-attachments/assets/fd2c00cd-ca45-4997-9780-1df1ea45610c">

### Step 5: Write Nodes for Controlling the Robot Arm
1. Create a `src` directory:
   ...
   ```
2. Write the ROS node code in `robot_arm_controller.cpp` to control the robot arm.

![image](https://github.com/user-attachments/assets/8d9a3a34-cb31-4a8e-ab13-5b4bdd229b45)
   

### Step 6: Build the Package
1. Go back to the root of the workspace and Build the package:
   ```sh
   cd ~/catkin_ws
   catkin_make
   ```
...
### Step 7: Launch the Robot Arm in RViz
1. Use the launch file to start the robot arm in RViz:
   ```sh
